...
const Register = () => {
    ...
    const fields = [
        { label: 'Nom complet',              icon: <User size={15} />,  type: 'text',     value: name,                 onChange: e => setName(e.target.value),                 placeholder: 'Jean Dupont' },
        { label: 'Adresse Email',            icon: <Mail size={15} />,  type: 'email',    value: email,                onChange: e => setEmail(e.target.value),                placeholder: 'nom@exemple.com' },
        { label: 'Mot de passe',             icon: <Lock size={15} />,  type: 'password', value: password,             onChange: e => setPassword(e.target.value),             placeholder: '••••••••' },
        { label: 'Confirmer le mot de passe',icon: <Lock size={15} />,  type: 'password', value: passwordConfirmation, onChange: e => setPasswordConfirmation(e.target.value), placeholder: '••••••••' },
    ];
    ...
    return (
        <>
            <style>{`
                ...
                .reg-input:focus { border-color: rgba(201,168,76,0.4) !important; }
                .reg-btn:hover:not(:disabled) { background: #e8c97a !important; }
                .reg-btn:disabled { opacity: 0.6; cursor: not-allowed; }
                .reg-link:hover { color: #e8c97a !important; }
            `}</style>
            ...
            <div style={s.page}>
                <div style={s.card}>
                    ...
                    <div style={s.logoWrap}>
                        <UserPlus size={20} style={{ color: '#c9a84c' }} />
                    </div>
                    ...
                    <div style={s.title}>Créer un compte</div>
                    <div style={s.subtitle}>Commencez à gérer vos clients aujourd'hui</div>
                    ...
                    <div style={s.footer}>
                        Déjà un compte ?{' '}
                        <Link to="/login" className="reg-link" style={s.footerLink}>
                            Se connecter
                        </Link>
                    </div>
